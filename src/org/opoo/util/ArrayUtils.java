...
public abstract class ArrayUtils
{
  ...
  public static Object[] concat(Object[] array1, Object[] array2)
  {
    ...
    if (length == 0) return EMPTY_OBJECT_ARRAY;
  ...
  {
    int length = array1.length + array2.length;
    if (length == 0) return EMPTY_STRING_ARRAY;
    if(array1.length == 0) return array2;
    if(array2.length == 0) return array1;
  ...
  public static Object concat(Object array1, Object array2, Class type)
  {
    ...
    if (length == 0)return Array.newInstance(type, 0);
    if (length1 == 0)return array2;
    if (length2 == 0)return array1;
  ...
  public static boolean isAllNotNull(Object array)
  {
    ...
    for (int i = 0; i < n; i++)
    {
      if (Array.get(array, i) == null)return false;
    }
    return true;
  }
